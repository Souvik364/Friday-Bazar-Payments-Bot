...
UPI_ID = os.getenv("UPI_ID", "your-upi-id@okaxis") # Default placeholder if not set
...
TRANSLATIONS = {
    "en": {
        ...
        "session_expired": "⚠️ <b>Session Expired</b>\n\nThe bot has restarted or your session timed out. Please select a plan again."
    },
    "hi": {
        "btn_premium": "🎥 YouTube Premium",
        "btn_help": "ℹ️ मदद",
